...
class amg
{
	...
	var $_def = array(
		'auth' => array(
			'apikey' => "ppdnxejktvy8tx3upgrmxrd9",
			'secret' => "Euh4rTYNQh"
		),
		'url' => array(
			'search' => 'http://api.rovicorp.com/search/v2.1/music/search?apikey=%s&sig=%s&query=%s&entitytype=album',
			'filter' => '&filter=%d', //use the decade
		)
